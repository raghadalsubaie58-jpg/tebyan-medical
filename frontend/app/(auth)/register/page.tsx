    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        ...
        >
          ...
          <Link
            href="/login"
            className="inline-flex items-center gap-2 text-sm text-teal-800 dark:text-teal-300 font-medium hover:underline underline-offset-2"
          >
        ...
        >
          ...
          <div className="glass-strong rounded-3xl p-8 shadow-2xl shadow-black/10">
            ...
            <p className="text-center text-sm text-muted-foreground">
              لديك حساب بالفعل؟{" "}
              <Link href="/login" className="text-teal-800 dark:text-teal-300 font-medium hover:underline underline-offset-2">تسجيل الدخول</Link>
            </p>
          </div>
